    ...
    <main>
      <div id="header" className="text-center">
        ...
        <h4 className="text-gray-300 font-light my-6 text-lg sm:text-xl">
          Where's all the gossip? The Secrets? It's here.<br /> Share all your secrets, confessions and gossip here <span className="font-extrabold">anonymously</span> at Branch-prompt <br />
        </h4>
