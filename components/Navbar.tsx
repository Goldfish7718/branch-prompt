  ...
  return (
    <nav className="z-10 fixed top-0  w-full">
        <div id="banner" className={`p-2 bg-red-600 flex items-center justify-center ${!bannerOpen && 'hidden'}`}>
            <Info size={18} className="mx-1 text-white ml-auto" />
            <h4 className="text-sm font-light text-white mr-auto">This website only has one maintainer. Please do not spam the feeds with useless prompts. Thank you!</h4>
